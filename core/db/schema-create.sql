    ...
    create table users (
        ...
        VISIBLE_INVENTORY_TAB_LIST CHARACTER VARYING(1024),
        ENABLE_STAFF_MODULE BOOLEAN not null,
        VISIBLE_STAFF_TAB_LIST CHARACTER VARYING(1024),
        ENABLE_COURSE_MODULE BOOLEAN not null,
        VISIBLE_COURSE_TAB_LIST CHARACTER VARYING(1024),
        ENABLE_TRIAL_MODULE BOOLEAN not null,
        VISIBLE_TRIAL_TAB_LIST CHARACTER VARYING(1024),
        ENABLE_INPUT_FIELD_MODULE BOOLEAN not null,
        VISIBLE_INPUT_FIELD_TAB_LIST CHARACTER VARYING(1024),
        ENABLE_PROBAND_MODULE BOOLEAN not null,
        VISIBLE_PROBAND_TAB_LIST CHARACTER VARYING(1024),
